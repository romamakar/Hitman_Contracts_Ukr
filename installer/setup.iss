...
#define MyAppName "Українізатор для Hitman: Contracts"
...
DefaultDirName={pf32}\Steam\steamapps\common\Hitman Contracts
DisableDirPage=no
...
[Run]
Filename:"{app}\HitmanContracts.exe"; Description:"Запустити Hitman Contracts"; Flags: postinstall nowait shellexec
